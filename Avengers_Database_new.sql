...
CREATE TABLE project (
	...
	cost_justification    VARCHAR(255),
...
INSERT INTO task_list (task_name, project_id, task_id, is_complete, due_date, mem_id)
    VALUES ('Create ERD', 300, 500, 'N', NULL, 1),
           ('Create DFD', 300, 501, 'N', NULL, NULL),
           ('Create WBS', 300, 502, 'N', NULL, NULL);
