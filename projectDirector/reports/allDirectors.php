<?php
	/*
		...
		Date: 3/7/22
		Filename: allDirector.php
	*/

require_once('../../inc/db_connect.php');
include('director/dir_name.php');
include('report_data3.php');
...
<aside>
	...
	<div class="report">
		...
		<div class="reportForm" id="excel_data">
			<h3>List of all Current Directors</h3>
			<table id="table_content" align="center">
				...
				<tr>
					<td><?php echo $director["dir_fname"]; ?></td>
					<td><?php echo $director["dir_lname"]; ?></td>
					<td><?php echo $director["username"]; ?></td>
				</tr>
				<?php endforeach; ?>
			</table>
		</div><br><br>
