<?php
	/*
		...
		Date: 3/7/22
		Filename: allTeams.php
	*/

require_once('../../inc/db_connect.php');
include('director/dir_name.php');
include('report_data5.php');
...
<aside>
	...
	<div class="report">
		<h1>CALU Project Tracking and Scheduling Reports Page</h1>
			...
			<h3>List of all Current Teams</h3>
			<table id="table_content" align="center">
				<tr>
					<th>Team Name</th>
					<th colspan="3">Team Description</th>
				</tr>
				<?php foreach($teams as $team): ?>
				<tr>
					<td><?php echo $team["team_name"]; ?></td>
					<td colspan="3"><?php echo $team["team_description"]; ?></td>
				</tr>
				<?php endforeach; ?>
			</table>
		</div><br><br>
