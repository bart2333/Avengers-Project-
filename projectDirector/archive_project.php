...
// prevents "ID# -- Project Name" submission error 
...
if (!empty($_SESSION['b']['project_id'])) {
 // prevents error when no project is selected prior to hitting Archive Project 
$query = 'SELECT *
...
$statement->execute();
$projectExists = $statement->fetch();
$statement->closeCursor();
 
//if the project wasn't archived already this will insert the archive into archive_project
...
$query = 'INSERT INTO archive_project
	...
	$error = "Project is archived. Please choose another project to continue";
...
<br>
	<fieldset class="grayBox">
		...
		<h3 style = "color: black;">Project Name: <?php echo $id;?> - <?php echo $project_name;?></h3>
