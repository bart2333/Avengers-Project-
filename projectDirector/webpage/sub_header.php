			...
			<ul> <!--  The main points are just placeholders and do not offer navigation to other pages if they include subsections -->
				...
				<li><a href="#Projects">Projects</a>
					<ul>
						...
						<li><a href="../assign_team_tasks.php">Assign Project Tasks to Team</a></li>
						<li><a href="../assign_team.php">Assign Team Members to Team</a></li>
						...
						<li><a href="../view_archived_project.php">View Archived Projects</a></li>
				...
				<li><a href="#messages">Messages</a>
					<ul>
						<li><a href="../pd_email.php">Send Email</a></li>
					</ul>				
				</li>
